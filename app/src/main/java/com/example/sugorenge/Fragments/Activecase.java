...
public class Activecase extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_activecase, container, false);
    ...
    private void Submit() {
        ...
        String url = BASE_URL + "vendor/activecase";
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (r_code == 1) {
                        ...
                        VendorcasesAdapter adapter = new VendorcasesAdapter(Sharelist, getContext(), "active");
