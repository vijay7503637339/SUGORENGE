...
import com.afroz.social.ahmad.adapters.PagerPhotosAdapter;
import com.afroz.social.ahmad.models.Images;
import com.afroz.social.ahmad.service.UploadService;
...
public class PostImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getSharedPreferences("theme",MODE_PRIVATE).getBoolean("dark",false)) {
            setContentView(R.layout.activity_post_image_dark);
