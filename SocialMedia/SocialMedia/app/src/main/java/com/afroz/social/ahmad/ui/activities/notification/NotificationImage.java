package com.afroz.social.ahmad.ui.activities.notification;
...
import com.afroz.social.ahmad.ui.activities.friends.SendActivity;
                ...
                if (!TextUtils.isEmpty(message_)) {
                    ...
                    mFirestore.collection("Users/" + user_id + "/Notifications_reply_image").add(notificationMessage).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        ...
                        public void onSuccess(DocumentReference documentReference) {
                            ...
                            Toasty.success(NotificationImage.this, "Hify sent!", Toasty.LENGTH_SHORT, true).show();
                            message.setText("");
