...
import com.afroz.social.ahmad.adapters.addFriends.RecyclerViewTouchHelper;
import com.afroz.social.ahmad.adapters.searchFriends.SearchFriendAdapter;
import com.afroz.social.ahmad.models.Friends;
...
public class SearchUsersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getSharedPreferences("theme",MODE_PRIVATE).getBoolean("dark",false)) {
            setContentView(R.layout.activity_search_users_dark);
