package com.afroz.social.ahmad.ui.activities.forum;
...
import com.afroz.social.ahmad.adapters.AnswersAdapter;
import com.afroz.social.ahmad.models.Answers;
...
public class AnswersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getSharedPreferences("theme",MODE_PRIVATE).getBoolean("dark",false)) {
            setContentView(R.layout.activity_answers_dark);
