package com.afroz.social.ahmad.receivers;
...
import com.afroz.social.ahmad.utils.NotificationUtil;
    ...
    private void handleDataMessage(RemoteMessage remoteMessage) {
        ...
        switch (click_action) {
            ...
            case "com.amsavarthan.social.hify.TARGET_FRIENDREQUEST":
                ...
                break;
            case "com.amsavarthan.social.hify.TARGET_ACCEPTED":

                Log.d("TARGET_ACCEPTED", "onMessageReceived: " + click_action);
                resultIntent = new Intent(getApplicationContext(), FriendProfile.class);

                break;
            case "com.amsavarthan.social.hify.TARGET_DECLINED":
